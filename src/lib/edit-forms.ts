...
export const participantFields: FormField[] = [
  ...
  },
  {
    ...
    type: "select",
    required: true,
    options: ["מאושר", "ממתין לתשלום", "ממתין לאישור", "טיוטה"],
  },
  {
    name: "paymentStatus",
    label: "סטטוס תשלום",
...
export const interactionFields: FormField[] = [
  {
    ...
    type: "select",
    required: true,
    options: ["שיחת טלפון", "פגישה", 'דוא"ל', "WhatsApp", "אחר"],
  },
...
export const familyFields: FormField[] = [
  ...
  { name: "assignedStaff", label: "איש צוות מלווה", required: true },
  {
    ...
    type: "select",
    required: true,
    options: ["בטיפול פעיל", "ממתינה לאישור", "מלווה", "סגורה", "בסיכון"],
  },
  {
    name: "needs",
    label: "צרכי סיוע",
...
export const expenseFields: FormField[] = [
  ...
  },
  {
    ...
    label: "חשבונית / קבלה",
    type: "select",
    options: ["חשבונית התקבלה", "חסרה חשבונית", "ממתין לאישור"],
  },
  { name: "reference", label: "אסמכתא" },
  { name: "notes", label: "הערות", type: "textarea", colSpan: 2 },
];
...
export const userFields: FormField[] = [
  ...
  { name: "status", label: "סטטוס", type: "select", required: true, options: ["פעיל", "מושעה"] },
  {
    ...
    colSpan: 2,
    helper: "מופרדות בפסיק — לדוגמה: אישור תשלומים, ייצוא דוחות",
  },
];
