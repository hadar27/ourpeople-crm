...
import { FamilyEditButton, FamilyDeleteButton } from "@/components/module-edit-dialogs";
...
export const Route = createFileRoute("/_app/families")({
  ...
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "ניהול משפחות מוטבות, בני משפחה, צרכים והיסטוריית סיוע במערכת Our People.",
      },
...
const columns: Column<Record<string, unknown>>[] = [
  {
    key: "familyName",
    header: "שם המשפחה",
    render: (r) => <span className="font-medium">{String(r.familyName)}</span>,
  },
  ...
  { key: "countryOfOrigin", header: "ארץ מוצא" },
  {
    key: "membersCount",
    header: "נפשות",
    render: (r) => <span className="tabular-nums">{String(r.membersCount)}</span>,
  },
  {
    key: "needs",
    header: "צרכים",
          ...
          <FormDialog
            ...
            fields={[
              ...
              },
              {
                ...
                label: "צרכים",
                colSpan: 2,
                placeholder: NEEDS.join(", "),
                helper: "הפרדה בפסיקים",
              },
        ...
        <DataTable
          rowActions={(r) => (
            <div className="flex items-center justify-end gap-2">
              <FamilyEditButton record={r as unknown as FamilyRecord} />
              <FamilyDeleteButton record={r as unknown as FamilyRecord} />
            </div>
          )}
...
function Kpi({
  ...
  return (
    <div className="card-elevated p-4">
      ...
      <div className={`text-xl font-bold mt-1 ${tone === "danger" ? "text-rose-600" : ""}`}>
        {value}
      </div>
    </div>
  );
