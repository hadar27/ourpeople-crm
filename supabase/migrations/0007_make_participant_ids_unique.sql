-- Regenerate participant id_numbers with valid Israeli ID numbers (matching 0006 approach)
-- This ensures participants have properly validated government ID numbers
...
-- Backfill participants with valid synthetic Israeli ID numbers
update public.participants
set id_number = generate_valid_israeli_id(id)
where id_number is not null;

-- Add unique constraint to ensure no duplicate Israeli IDs
